...
DROP TRIGGER IF EXISTS TR_T_IDENTITY_TO_ROLE_LM ON T_IDENTITY_TO_ROLE CASCADE ;
CREATE TRIGGER TR_T_IDENTITY_TO_ROLE_LM BEFORE INSERT OR UPDATE ON T_IDENTITY_TO_ROLE FOR EACH ROW EXECUTE PROCEDURE F_LAST_MODIFIED() ;
...
DROP TRIGGER IF EXISTS TR_T_ROLE_LM ON T_ROLE CASCADE ;
CREATE TRIGGER TR_T_ROLE_LM BEFORE INSERT OR UPDATE ON T_ROLE FOR EACH ROW EXECUTE PROCEDURE F_LAST_MODIFIED() ;

DROP TRIGGER IF EXISTS TR_T_ROLE_TO_RIGHT_LM ON T_ROLE_TO_RIGHT CASCADE ;
CREATE TRIGGER TR_T_ROLE_TO_RIGHT_LM BEFORE INSERT OR UPDATE ON T_ROLE_TO_RIGHT FOR EACH ROW EXECUTE PROCEDURE F_LAST_MODIFIED() ;
