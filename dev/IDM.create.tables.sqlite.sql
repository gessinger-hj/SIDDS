...
(
  ...
  LAST_MODIFIED      DATE                       DEFAULT current_timestamp               NOT NULL,
  RIGHT_VALUE        VARCHAR2(512)         NOT NULL,
...
CREATE TRIGGER IF NOT EXISTS TR_I_T_IDENTITY_LM
AFTER INSERT ON T_IDENTITY FOR EACH ROW
BEGIN
...
------------
CREATE TRIGGER IF NOT EXISTS TR_I_T_IDENTITY_TO_IDENTITY_LM
AFTER INSERT ON T_IDENTITY_TO_IDENTITY FOR EACH ROW
BEGIN
...
CREATE TRIGGER IF NOT EXISTS TR_I_T_IDENTITY_TO_RIGHT_LM
AFTER INSERT ON T_IDENTITY_TO_RIGHT FOR EACH ROW
BEGIN
...
CREATE TRIGGER IF NOT EXISTS TR_I_T_IDENTITY_TYPE_LM
AFTER INSERT ON T_IDENTITY_TYPE FOR EACH ROW
BEGIN
...
CREATE TRIGGER IF NOT EXISTS TR_I_T_RIGHT_LM
AFTER INSERT ON T_RIGHT FOR EACH ROW
BEGIN
